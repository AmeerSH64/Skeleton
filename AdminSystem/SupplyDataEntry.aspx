...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Label ID="lblSupplierName" runat="server" Text="Supplier Name" width="119px"></asp:Label>
        ...
        <asp:Button ID="btnOK" runat="server" OnClick="btnOK_Click" Text="OK" style="width: 37px" />
